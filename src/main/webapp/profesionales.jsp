...
<body>
    ...
    <div class="content">
        ...
        <table class="styled-table">
            ...
            <tbody>
                <%
                    // Verifica si la lista de profesionales está disponible y no está vacía
                ...
                %>
                <tr>
                    <td><%= profesional.getId() %></td>
                    <td><%= profesional.getNombreCompleto() %></td>
                    <td><%= profesional.getEspecialidad() %></td>
                    <td><%= profesional.getAniosExperiencia() %></td>
                    <td><%= profesional.getProyectosPrevios() %></td>
                    <td><%= profesional.getContacto() %></td>
                    <td><%= profesional.getInstitucionEducativa() %></td>
                    <td><%= profesional.getEstiloPreferido() %></td>
                    <td>
                        <%
                            // Verifica si hay una imagen disponible para mostrar
                            if (profesional.getImagen() != null && !profesional.getImagen().isEmpty()) {
                        %>
                ...
                %>
                <tr>
                    <td colspan="10">No hay profesionales registrados.</td>
                </tr>
                <% } %>
            </tbody>
        </table>
