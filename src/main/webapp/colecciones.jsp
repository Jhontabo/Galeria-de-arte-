                                ...
                                <% List<Coleccion> colecciones = (List<Coleccion>) request.getAttribute("colecciones");
                                        List<ObraDeArte> obras = (List<ObraDeArte>) request.getAttribute("obras");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%= coleccion.getResponsable() %>
                                                    </td>
                                                    <td>
                                                        <%= coleccion.getEstilo() %>
                                                    </td>
                                                    <td>
                                                        <% if (coleccion.getObrasIncluidas() !=null) { for (Integer
                                                            obraId : coleccion.getObrasIncluidas()) { String
                                                            obraNombre=obras.stream() .filter(o -> o.getId() == obraId)
                                                            .map(o -> o.getTitulo())
                                                            .findFirst()
                                                    ...
                                                    <td>
                                                        <%= coleccion.getFechasExhibicion() %>
                                                    </td>
                                                    <td>
                                                        <%= coleccion.getSalaAsignada() %>
                                                    </td>
                                                    <td>
                                                        <%= coleccion.getObservaciones() %>
                                                    </td>
                                                    <td>
                                                        <form action="editarColeccion" method="get"
                                                            enctype="multipart/form-data" style="display:inline;">
                                                            <input type="hidden" name="id"
                                                                value="<%= coleccion.getId() %>">
                                                            <button type="submit" class="btn-edit">Editar</button>
                                                        </form>
                                                        <form action="eliminarColeccion" method="get"
                                                            style="display:inline;">
                                                            <input type="hidden" name="action" value="delete">
                                                            <input type="hidden" name="id"
                                                                value="<%= coleccion.getId() %>">
                                                            <button type="submit" class="btn-delete"
                                                                onclick="return confirm('¿Eliminar esta colección?');">Eliminar</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <% } } else { %>
                        ...
                        <form action="colecciones" method="post" enctype="multipart/form-data" class="styled-form">
                            ...
                            <div class="form-group">
                                ...
                                <select id="obrasIncluidas" name="obrasIncluidas" multiple>
                                    <% if (obras !=null) { for (ObraDeArte obra : obras) { %>
